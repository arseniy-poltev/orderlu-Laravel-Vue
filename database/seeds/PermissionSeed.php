...
class PermissionSeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 17, 'title' => 'courier_company_access',],
            ['id' => 18, 'title' => 'courier_company_create',],
            ['id' => 19, 'title' => 'courier_company_edit',],
            ['id' => 20, 'title' => 'courier_company_view',],
            ['id' => 21, 'title' => 'courier_company_delete',],
