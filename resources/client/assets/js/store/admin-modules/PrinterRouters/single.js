...
const actions = {
    storeData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/api/v1/printer-routers', params)
                .then(response => {
                    commit('resetState')
                    resolve()
                })
    ...
    updateData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/api/v1/printer-routers/' + state.item.id, params)
                .then(response => {
    ...
    fetchData({ commit, dispatch }, id) {
        commit('setLoading', true)
        return new Promise((resolve, reject) => {
            axios.get('/api/v1/printer-routers/' + id)
                .then(response => {
                    commit('setItem', response.data.data)
                    resolve()
                })
    ...
    setPrinterCompanies({ commit }, value) {
        commit('setPrinterCompanies', value)
    },
    resetState({ commit }) {
        commit('resetState')
    }
...
const mutations = {
    ...
    setPrinterCompanies(state, value) {
        state.item.printer_companies = JSON.stringify(value);
    },
