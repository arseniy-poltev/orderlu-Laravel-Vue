<template>
  <div class="my-button">
    <div class="outer">
      <div class="height" @click="func">
        <div class="inner">This book is Printed!</div>
      </div>
    </div>
  </div>
</template>
...
.my-button .outer .height {
  ...
  -webkit-box-shadow: rgba(0, 0, 0, 0.85) 0px 1px 1px,
    inset rgba(0, 0, 0, 0.35) 0px -2px 8px;
  -moz-box-shadow: rgba(0, 0, 0, 0.85) 0px 1px 1px,
    inset rgba(0, 0, 0, 0.35) 0px -2px 8px;
  -webkit-transition: all 0.1s ease-in-out;
  -moz-transition: all 0.1s ease-in-out;
}
.my-button:hover .outer .height {
  margin-top: -10px;
  padding-bottom: 10px;
  background: #3aaf2d;
  ...
  -webkit-box-shadow: rgba(0, 0, 0, 0.25) 0px 1px 1px,
    inset rgba(0, 0, 0, 0.35) 0px -2px 6px;
  -moz-box-shadow: rgba(0, 0, 0, 0.25) 0px 1px 1px,
    inset rgba(0, 0, 0, 0.35) 0px -2px 6px;
}
.my-button:active .outer .height {
  margin-top: 0px;
  padding-bottom: 0px;
}
.my-button .outer .height .inner {
  /* line-height: 2em; */
  font-size: 30px;
...
.my-button:hover .outer .height .inner {
...
.my-button:active .outer .height .inner {
