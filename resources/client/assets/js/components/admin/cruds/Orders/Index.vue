            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-3 form-group">
                  <label for="title">Search By Order ID</label>
                  <input
                    type="text"
                    class="form-control"
                    name="search"
...
export default {
  data() {
    return {
      ...
      columns: [
        ...
        { title: "Name of Book", field: "book_name", sortable: true },
        {
        ...
        { title: "Printed At", field: "printed_at", sortable: true },
        { title: "Picked At", field: "picked_at", sortable: true },
        { title: "Delivered At", field: "delivered_at", sortable: true },
        {
          title: "Courier Tracking",
          field: "courier_tracking",
          sortable: true
        },
        {
          title: "Actions",
      ...
      keyword: "",
      query: { sort: "id", order: "desc", limit: 10 },
      xprops: {
        module: "OrdersIndex",
        route: "orders",
  ...
  computed: {
    ...mapGetters("OrdersIndex", ["data", "total", "loading", "relationships"])
  },
  watch: {
    query: {
      handler(query) {
  ...
  methods: {
    ...mapActions("OrdersIndex", ["fetchData", "setQuery", "resetState"]),
    getData() {
      this.query = { sort: "id", order: "desc", limit: 10 };
      this.keyword = "";
      this.fetchData();
    },
    search() {
      ...
      this.$set(this.query, "order_id", this.keyword);
